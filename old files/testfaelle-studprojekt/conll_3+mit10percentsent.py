...
tagger.add_and_switch_to_new_task("TEST_NER_CONLL3+MIT10PERCENT", tag_dictionary=label_dictionary, tag_type=tag_type)

trainer = ModelTrainer(tagger, corpus)
trainer.train(
    base_path='resources/testfaelle-studproj/conll_3+mit10percentsent',
    learning_rate=0.1,
    mini_batch_size=32,
