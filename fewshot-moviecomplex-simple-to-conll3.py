...
tagger = TARSSequenceTagger2.load("resources/v1/moviecomplex-simple/final-model.pt")
...
tagger.add_and_switch_to_new_task("fewshot-moviecomplex-simple-to-conll3", tag_dictionary=tag_dictionary, tag_type=tag_type)
trainer.train(
    base_path='resources/v1/fewshot-moviecomplex-simple-to-conll3-k' + str(k),
