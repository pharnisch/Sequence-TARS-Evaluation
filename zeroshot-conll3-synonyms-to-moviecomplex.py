...
tagger = TARSSequenceTagger2.load("resources/v3/conll_3-synonyms/final-model.pt")
...
tagger.add_and_switch_to_new_task("zeroshot-conll_3-synonyms-to-moviecomplex", tag_dictionary=tag_dictionary, tag_type=tag_type)
