...
tagger = TARSSequenceTagger2.load("resources/v1/sequence-3/final-model.pt")
...
tagger.add_and_switch_to_new_task("sequence-4-train", tag_dictionary=tag_dictionary, tag_type=tag_type)

trainer = ModelTrainer(tagger, corpus, optimizer=torch.optim.AdamW)
trainer.train(
    base_path='resources/v1/sequence-4',
