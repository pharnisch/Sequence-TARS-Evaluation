...
tagger = TARSSequenceTagger2.load("resources/v3/moviecomplex-cryptic/final-model.pt")
...
tagger.add_and_switch_to_new_task("zeroshot-moviecomplex-cryptic-to-conll3", tag_dictionary=tag_dictionary, tag_type=tag_type)
