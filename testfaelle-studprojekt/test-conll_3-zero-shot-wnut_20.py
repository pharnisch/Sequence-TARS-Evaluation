...
corpus = WNUT_2020_NER(tag_to_bioes=None, label_name_map=label_name_map)
corpus = corpus.downsample(0.1)
corpus_sents = []

tag_dictionary = corpus.make_label_dictionary()
tagger.add_and_switch_to_new_task("EVALUATION", tag_dictionary=tag_dictionary, tag_type="ner")
